...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Organizador</h1>
                ...
                <tbody>
                    <c:forEach var="organizador" items="${organizadores}">                    
                       ...
                       <td align="center">${organizador.cidade.nomeCidade}-${organizador.cidade.estado.siglaEstado}</td>
                            ...
                            <td align="center">
                                <a href="#" onclick="deletar(${organizador.idOrganizador})">
                                    <button class="btn 
                        ...
                        <div class="form-line row">
                            ...
                            <div class="col-sm">
                                ...
                                <select class="form-control" name="permitelogin" id="permitelogin">
                                    <option value="N" ${organizador.permiteLogin == 'N' ? "selected" : ""}>Não</option>
...
<script>
    ...
    function setDadosModal(valor) {
        ...
        var idOrg = valor;
        if (idOrg != "0"){
            //existe Organizador para buscar (alteração)
        ...
        $(document).ready(function () {
            $.getJSON('PessoaBuscarCpfCnpj', {cpfcnpjpessoa: idM, tipopessoa: tipoPessoa}, function (respostaOrg) {
                ...
                if (respostaOrg != null)
                {
                    ...
                    //se não encontrou organizador busca por pessoa somente
                    tipoPessoa = 'pessoa';
    ...
    function deletar(codigo){
        ...
        Swal.fire({
            ...
            text: "Você deseja realmente inativar/ativar o organizador?",
            icon: 'warning',
                        ...
                        function(data){
                            if(data == 1){
                                ...
                                Swal.fire({
                                    ...
                                    icon: 'error',
                                    title: 'Erro',
                                    text: 'Não foi possível inativar Organizador!',
                                    showConfirmButton: true,
                                    timer: 10000
                                }).then(function(){
                                    window.location.href = "${pageContext.request.contextPath}/OrganizadorListar";
                    ...
                    function (data) {
                        ...
                        if (data == 1) {
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                title: 'Erro',
                                text: 'Não foi possível gravar o Organizador!',
                                showConfirmButton: true,
                                timer: 10000
                            }).then(function(){
                                window.location.href = "${pageContext.request.contextPath}/OrganizadorListar";
