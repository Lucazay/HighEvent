...
@WebServlet(name = "OrganizadorListar", urlPatterns = {"/OrganizadorListar"})
public class OrganizadorListar extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=iso-8859-1");
        try{
            GenericDAO dao = new OrganizadorDAO();
            request.setAttribute("organizadores",dao.listar());
