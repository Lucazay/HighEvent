...
@WebServlet(name = "OrganizadorEventoCadastrarGeral", urlPatterns = {"/OrganizadorEventoCadastrarGeral"})
public class OrganizadorEventoCadastrarGeral extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("/cadastros/organizadorevento/organizadorEventoCadastrar.jsp").forward(request, response);
        } catch (Exception ex){
