...
@WebServlet(name = "InstituicaoCadastrar", urlPatterns = {"/InstituicaoCadastrar"})
public class InstituicaoCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            System.out.println("Problemas no servlet cadastrar Instituicao! Erro: "+e.getMessage());
            e.printStackTrace();
        }
    }
