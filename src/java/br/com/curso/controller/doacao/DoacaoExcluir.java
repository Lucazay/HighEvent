...
@WebServlet(name = "DoacaoExcluir", urlPatterns = {"/DoacaoExcluir"})
public class DoacaoExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Problemas no Servelet ao excluir Doacao! Erro: "+ ex.getMessage());
            ex.printStackTrace();
        }
    }
